...
<!--     <link href="http://getbootstrap.com/examples/signin/signin.css" rel="stylesheet"> -->
  ...
  <body>
    ...
    <div class="container">
      <h1 align="center">
      	<a href="<?php echo $this->config['domain']['url']; ?>" title="Powered by 
      		<?php echo $this->config['domain']['name']; ?>"><img class='img-responsive img-center logo' 
      		src='<?php echo $this->config['domain']['url'].'/'.$this->config['template']['path'].'/'.$this->config['template']['name']; ?>/images/mylogo.jpg'   /></a></h1>
	  <div id="login_error" style="display:none"></div> <!-- error message shows here -->
      <form class="form-signin" role="form" action="<?php echo $this->link('home/index'); ?>" method="post">
        ...
        <div style='clear: both; margin-top: 5px;' align='center'>------- <strong>OR</strong> Login with -------</div>
		...
		<div class='toolbar'>
			<div class='left_pass'><a href="<?php echo $this->link('login/forgetPassword'); ?>" title="Password Lost and Found">Lost your password?</a></div>
			<div class='right_register'><a href="<?php echo $this->link('register/index'); ?>" title="Password Lost and Found">Register</a></div>
		</div>
